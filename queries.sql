...
SELECT * FROM invoices WHERE total > 5 AND billing_city = 'Chicago';
-- The billing addresses of the 5 most valuable invoices from Mountain View CA
-- Gotta reward those big spenders!
SELECT billing_address FROM invoices WHERE billing_city = 'Mountain View' ORDER BY total DESC;
...
SELECT * FROM invoices WHERE invoice_date < '2010-01-01' ORDER BY total DESC;
